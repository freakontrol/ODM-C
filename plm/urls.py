...
from .views import (PartViewSet, PartCategoryViewSet, DocumentCategoryViewSet, ManufacturerViewSet,
                    PurchaseOptionViewSet, ContainerViewSet, DocumentViewSet, PartDocumentViewSet)
from . import views
...
urlpatterns = [
    ...
    path('api/parts/<str:internal_part_number>/', PartViewSet.as_view({'get': 'retrieve'}), name='part-detail'),  # add this line
